...
static const wchar_t Name[] = L"vgmstream decoder v0.2.2 (r1980)";
...
template <typename T>
class CoreBasedObj : public IUnknownInterfaceImpl <T>
{

public:
    IAIMPCore* core;

    CoreBasedObj(IAIMPCore* core) 
    {
        this->core = core;
    }
...
class Decoder : public CoreBasedObj<IAIMPAudioDecoder>
{
private:
...
public:
    ...
    Decoder(IAIMPCore* core, VGMSTREAM* stream, INT64 fileSize);
    ~Decoder();

    virtual BOOL WINAPI GetFileInfo(IAIMPFileInfo* info);
...
class DecoderExtension : public CoreBasedObj<IAIMPExtensionAudioDecoderOld>
{
public:

    DecoderExtension(IAIMPCore* core) : CoreBasedObj(core) {};
...
class FileFormatsExtension : public CoreBasedObj<IAIMPExtensionFileFormat>
{
public:

    FileFormatsExtension(IAIMPCore* core) : CoreBasedObj(core) {};
